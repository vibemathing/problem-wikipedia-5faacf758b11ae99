...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-5faacf758b11ae99"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-5faacf758b11ae99",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-5faacf758b11ae99",
        "url": "https://en.wikipedia.org/wiki/Recam%C3%A1n%27s_sequence"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Does every nonnegative integer appear in Recamán's sequence ?",
      "version": 1
    },
    "title": "Does every nonnegative integer appear in Recamán's sequence ?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "370704ce10ddfe096f3fe63e75608cd38202363ef5eef3498fe28ce14bd3b2d9"
}
```
